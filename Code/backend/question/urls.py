...
urlpatterns = [
    ...
    path('search/<str:search>/page_count/', views.questionSearchPageCount),

    path('category/<str:search>/page/<int:page>/', views.questionCategoryByPage),
    path('category/<str:search>/page_count/', views.questionCategoryPageCount)
]